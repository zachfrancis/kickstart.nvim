...
require('lazy').setup({
  ...
  'mfussenegger/nvim-jdtls', -- Required for bemol: https://w.amazon.com/bin/view/Bemol#HnvimbuiltinLSP
  ...
  },
  {
    ...
    config = function()
      ...
      -- From https://w.amazon.com/bin/view/Bemol#HnvimbuiltinLSP
